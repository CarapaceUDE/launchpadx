import { Play, Square, Info, RefreshCw, ChevronDown, Loader2 } from "lucide-react";
...
export function LaunchPanel({
  ...
  const isDisabled = !running && !canStart || isLaunching;
     ...
     <Card className="!p-6">
       <div className="flex items-start justify-between gap-4">
         <div className="flex items-center gap-2">
           ...
           <span className="shrink-0 rounded-full border border-border bg-secondary/60 px-2.5 py-0.5 text-[11px] font-medium text-muted-foreground">
