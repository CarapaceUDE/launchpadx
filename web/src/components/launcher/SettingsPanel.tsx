...
export function SettingsPanel() {
  const { config, saveConfig, statusMessage, models, running, refreshModels } = useLauncher();
    ...
    <div className="card-surface space-y-5 p-6">
      ...
      <div className="flex gap-2">
        <button
          ...
          className="flex flex-1 items-center justify-center gap-2 rounded-lg border border-input bg-background px-3 py-2 text-xs text-foreground transition-colors hover:bg-muted/70"
        >
        ...
        <button
          ...
          className="flex flex-1 items-center justify-center gap-2 rounded-lg bg-primary px-3 py-2 text-xs text-primary-foreground transition-colors hover:bg-primary-hover"
        >
